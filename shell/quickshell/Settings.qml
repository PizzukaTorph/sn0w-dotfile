                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                Text { text: "Terminal"; color: "#8f9aaa"; font.pixelSize: 10 }
                                TextField { id: terminalField; Layout.fillWidth: true; text: settingsState.terminal; color: "#f4f7fb"; font.pixelSize: 11 }
                                Text { text: "File manager"; color: "#8f9aaa"; font.pixelSize: 10 }
                                TextField { id: filesField; Layout.fillWidth: true; text: settingsState.fileManager; color: "#f4f7fb"; font.pixelSize: 11 }
                                Text { text: "Editor"; color: "#8f9aaa"; font.pixelSize: 10 }
                                TextField { id: editorField; Layout.fillWidth: true; text: settingsState.editor; color: "#f4f7fb"; font.pixelSize: 11 }
                            }
                        }
                    }
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                Text { text: "Screenshots"; color: "#8f9aaa"; font.pixelSize: 10 }
                                TextField { id: screenshotsField; Layout.fillWidth: true; text: settingsState.screenshotsDir; color: "#f4f7fb"; font.pixelSize: 11 }
                                Text { text: "Recordings"; color: "#8f9aaa"; font.pixelSize: 10 }
                                TextField { id: recordingsField; Layout.fillWidth: true; text: settingsState.recordingsDir; color: "#f4f7fb"; font.pixelSize: 11 }
                            }
                        }
                    }
                }
